...
_ATTRDEF = _descriptor.Descriptor(
  ...
  nested_types=[_ATTRDEF_LISTVALUE, _ATTRDEF_LISTLISTINT, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
