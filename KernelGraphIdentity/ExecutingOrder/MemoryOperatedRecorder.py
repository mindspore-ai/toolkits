...
class MemoryOperatedRecorder:
    ...
    """
    def __init__(self):
        self._memory_id_operations: dict[str, list[Operation]] = {}
    ...
    def record_operation(
        ...
        self._memory_id_operations.setdefault(memory_id, [])
        operation = Operation(node, memory_attribute, input_or_output)
        self._memory_id_operations[memory_id].append(operation)
