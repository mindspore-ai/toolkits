...
| --mindformers             | run_mindformer.py路径        | None                          | 是  |
| --mindspeed               | posttrain_gpt.py路径         | None                          | 是  |
| --output_file             | 放置输出文件的路径             | None                          | 是  |
| --offset                  | 各stage的层配置               | None                          | 是  |
| --is_recompute            | 是否开完全重计算              | None                          | 是  |
| --recompute_layers        | 完全重计算配置                | None                          | 是  |
| --is_select_recompute     | 是否开选择重计算              | None                          | 是  |
| --select_recompute_layers | 选择重计算配置                | None                          | 是  |
