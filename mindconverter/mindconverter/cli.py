...
def cli_entry():
    ...
    parser = argparse.ArgumentParser(
        prog='mindconverter',
        description='MindConverter CLI entry point (version: {})'.format(mindconverter.__version__))

    parser.add_argument(
        '--version',
        action='version',
        version='%(prog)s ({})'.format(mindconverter.__version__),
        help="显示Mindconverter的版本信息")
